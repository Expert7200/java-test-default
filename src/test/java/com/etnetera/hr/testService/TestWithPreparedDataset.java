...
/**
 * Class, provides dataset with 5 different frameworks.
 * 
 * @author Bogdan
 *
 */
public class TestWithPreparedDataset {
	...
	public void prepareData() throws Exception {
		...
		repository.save(createFramework("Vue.js", 60, localDate, "v3-dev", "v2-dev", "v1-dev"));
		repository.save(createFramework("Angular.js", 70, localDate, "v1.7.x", "v1.6.x"));
		repository.save(createFramework("Three.js", 50, localDate, "dev"));
		repository.save(createFramework("Bootstrap", 90, localDate));
	}
	 ...
	 * @return created instance of JavaScriptFramework
	 */
